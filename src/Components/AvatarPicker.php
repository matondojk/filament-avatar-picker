    ...
    protected function setUp(): void
    {
        ...
        $this->avatar()
            ...
            ->extraAttributes([
                ...
                'x-init' => "if(!document.getElementById('avatar-style')){ let s=document.createElement('style'); s.id='avatar-style'; s.innerHTML='.avatar-filepond-wrapper .fi-fo-file-upload-input-ctn { width: 6.5rem !important; height: 6.5rem !important; margin-inline: auto; } .avatar-filepond-wrapper { cursor: pointer; } .avatar-filepond-wrapper .filepond--action-remove-item { position: absolute !important; top: auto !important; bottom: 0 !important; z-index: 50 !important; } .filament-avatar-picker-browse-link { color: #f97316; color: var(--primary-600); color: rgb(var(--primary-600)); font-weight: 500; text-decoration: underline; cursor: pointer; }'; document.head.appendChild(s); }",
